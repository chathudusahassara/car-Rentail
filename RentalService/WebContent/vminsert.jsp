...
<header>
  ...
  <div class="hamburger">
    ...
    <div class="page-wrapper bg-red p-t-180 p-b-100 font-robo">
		...
		<form action="insert" method ="post" name="f1" onsubmit="return validate()">
		
		<div class="input-group">
		<input class="input--style-2" type="text" placeholder="Name" name="vname">
                        </div>
        
                                            
		<div class="input-group">
		<input class="input--style-2" type="text" placeholder="Chassis number" name="cno">
                        </div>
        
                                          
		<div class="input-group">
		<input class="input--style-2" type="text" placeholder="Shop name" name="shop">
                        </div>
		...
		<div class="input-group">
		<input class="input--style-2" type="text" placeholder="Maintain Fee" name="mfee"><span id="numloc"> </span>
                        </div>
                        
		<div class="input-group">
		<input class="input--style-2" type="text" placeholder="Image Link" name="ilink">
                        </div>
